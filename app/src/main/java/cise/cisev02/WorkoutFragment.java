...
public class WorkoutFragment extends Fragment {
    ...
    public void updateArticleView(int position) {
         ...
         * of NavDrawer.
         * Regardless, you can see how getActivity().findViewById accesses an editable version of
         * the object, whether it's a text or image view.*/
        //TextView article = (TextView) getActivity().findViewById(R.id.workout_text);
